...
dist/cine.js:	src/cinejs.js src/Player.js src/filters/BrightnessContrast.js src/filters/ColourLevel.js src/filters/GaussianBlur.js src/filters/Invert.js src/filters/Posterise.js | dist
	cat $^ > $@
